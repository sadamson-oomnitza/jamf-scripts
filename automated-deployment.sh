...
echo "Command: MainText: Thank you for choosing a Mac at $company! We want you to have a few applications and settings configured before you get started. This process should take 10 to 20 minutes to complete.  If you need additional software or help, please visit the Self Service app in your Applications folder or on your Dock." >> "$DEPNotifyConfig"
...
echo "Command: MainText: Please do not shutdown, reboot, or close your Mac. The whole process will take 10-20 minutes depending on internet speeds.  This window will automatically close when installation is complete.  Do not close or switch out of this message until complete." >> "$DEPNotifyConfig"
...
echo "Status: Updating inventory in then Jamf Pro Server..." >> "$DEPNotifyConfig"
